        ...
        692: function(e, t) {
            ...
            !function(t, n) {
                ...
                var M = x
                  , P = l;
                !function() {
                    var e, t, n, i, a, u, l, f, p, h, g = P, m = S.expando, y = 0, x = 0, b = ee(), w = ee(), T = ee(), C = ee(), k = function(e, t) {
                        return e === t && (a = !0),
                        0
                    }, E = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", H = "(?:\\\\[\\da-fA-F]{1,6}" + q + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", O = "\\[" + q + "*(" + H + ")(?:" + q + "*([*^$|!~]?=)" + q + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + q + "*\\]", R = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + O + ")*)|.*)\\)|)", I = new RegExp(q + "+","g"), W = new RegExp("^" + q + "*," + q + "*"), F = new RegExp("^" + q + "*([>+~]|" + q + ")" + q + "*"), _ = new RegExp(q + "|>"), $ = new RegExp(R), B = new RegExp("^" + H + "$"), z = {
                        ID: new RegExp("^#(" + H + ")"),
                        CLASS: new RegExp("^\\.(" + H + ")"),
                        TAG: new RegExp("^(" + H + "|[*])"),
                        ATTR: new RegExp("^" + O),
                    ...
                    try {
                        g.apply(o = s.call(M.childNodes), M.childNodes),
                    ...
                    function Z(e, t, n, r) {
                        var i, o, a, s, l, c, d, h = t && t.ownerDocument, y = t ? t.nodeType : 9;
                        if (n = n || [],
                        ...
                        f)) {
                            ...
                            if (!(C[e + " "] || p && p.test(e))) {
                                if (d = e,
                                h = t,
                                1 === y && (_.test(e) || F.test(e))) {
                                    for ((h = G.test(e) && se(t.parentNode) || t) == t && v.scope || ((s = t.getAttribute("id")) ? s = S.escapeSelector(s) : t.setAttribute("id", s = m)),
                                    o = (c = ce(e)).length; o--; )
                    ...
                    function ue(e) {
                        ...
                        l.msMatchesSelector && M != u && (n = u.defaultView) && n.top !== n && n.addEventListener("unload", J),
                        ...
                        ne((function(e) {
                            var t;
                            l.appendChild(e).innerHTML = "<a id='" + m + "' href='' disabled='disabled'></a><select id='" + m + "-\r\\' disabled='disabled'><option selected=''></option></select>",
                        ...
                        k = function(e, t) {
                            ...
                            return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !v.sortDetached && t.compareDocumentPosition(e) === n ? e === u || e.ownerDocument == M && Z.contains(M, e) ? -1 : t === u || t.ownerDocument == M && Z.contains(M, t) ? 1 : i ? c.call(i, e) - c.call(i, t) : 0 : 4 & n ? -1 : 1)
                        }
                        ,
                        u) : u
                    }
                    ...
                    t = S.expr = {
                        ...
                        preFilter: {
                            ...
                            PSEUDO: function(e) {
                                var t, n = !e[6] && e[2];
                                return z.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && $.test(n) && (t = ce(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                                e[2] = n.slice(0, t)),
                                e.slice(0, 3))
                            }
                        },
                        filter: {
                            ...
                            CHILD: function(e, t, n, r, i) {
                                ...
                                : function(t, n, u) {
                                    ...
                                    if (g) {
                                        ...
                                        a && x) {
                                            for (b = (p = (l = (c = g[m] || (g[m] = {}))[e] || [])[0] === y && l[1]) && l[2],
                                            f = p && g.childNodes[p]; f = ++p && f && f[h] || (b = p = 0) || d.pop(); )
                                                if (1 === f.nodeType && ++b && f === t) {
                                                    c[e] = [y, p, b];
                                                    break
                                                }
                                        } else if (x && (b = p = (l = (c = t[m] || (t[m] = {}))[e] || [])[0] === y && l[1]),
                                        !1 === b)
                                            for (; (f = ++p && f && f[h] || (b = p = 0) || d.pop()) && (!(s ? j(f, v) : 1 === f.nodeType) || !++b || (x && ((c = f[m] || (f[m] = {}))[e] = [y, b]),
                                            f !== t)); )
                                                ;
                            ...
                            PSEUDO: function(e, n) {
                                ...
                                return i[m] ? i(n) : i.length > 1 ? (r = [e, e, "", n],
                    ...
                    function ge(e, t, n, r, i, o) {
                        ...
                        i && !i[m] && (i = ge(i, o)),
                        te((function(o, a, s, u) {
                            var l, f, p, d, h = [], v = [], m = a.length, y = o || function(e, t, n) {
                                for (var r = 0, i = t.length; r < i; r++)
                                    Z(e, t[r], n);
                                return n
                            }(t || "*", s.nodeType ? [s] : s, []), x = !e || !o && t ? y : he(y, h, e, s, u);
                            if (n ? n(x, d = i || (o ? e : m || r) ? [] : a, s, u) : d = x,
                            r)
                                for (l = he(d, v),
                                r(l, [], s, u),
                                f = l.length; f--; )
                            ...
                            if (o) {
                                ...
                                d = he(d === a ? d.splice(m, d.length) : d),
                    ...
                    function ve(e) {
                        for (var r, i, o, a = e.length, s = t.relative[e[0].type], u = s || t.relative[" "], l = s ? 1 : 0, f = pe((function(e) {
                            ...
                            if (i = t.relative[e[l].type])
                                ...
                                if ((i = t.filter[e[l].type].apply(null, e[l].matches))[m]) {
                    ...
                    function me(e, r) {
                        ...
                        if (!s) {
                            for (r || (r = ce(e)),
                            i = r.length; i--; )
                                (s = ve(r[i]))[m] ? o.push(s) : a.push(s);
                            s = T(e, function(e, r) {
                                var i = r.length > 0
                                  , o = e.length > 0
                                  , a = function(a, s, l, c, p) {
                                    var d, h, v, m = 0, x = "0", b = a && [], w = [], T = n, C = a || o && t.find.TAG("*", p), k = y += null == T ? 1 : Math.random() || .1, E = C.length;
                                    ...
                                    i && x !== m) {
                                        ...
                                        g.apply(c, w),
                                        p && !a && w.length > 0 && m + r.length > 1 && S.uniqueSort(c)
                                    }
                                    return p && (y = k,
                                    n = T),
                                    b
                    ...
                    function ye(e, n, r, i) {
                        ...
                        return (c || me(e, p))(i, n, !f, r, !n || G.test(e) && se(n.parentNode) || n),
                        r
                    }
                    le.prototype = t.filters = t.pseudos,
                    t.setFilters = new le,
                    v.sortStable = m.split("").sort(k).join("") === m,
                    ue(),
                ...
                S.fn.extend({
                    ...
                    is: function(e) {
                        return !!_(this, "string" == typeof e && W.test(e) ? S(e) : e || [], !1).length
                    }
                });
                var $, B = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
                          ...
                          , i = {
                            ...
                            then: function(e, n, i) {
                                        ...
                                        var s = this
                                          ...
                                          , l = function() {
                                            ...
                                            if (!(e < o)) {
                                                ...
                                                m(l) ? i ? l.call(r, a(o, t, G, i), a(o, t, Y, i)) : (o++,
                                ...
                                return S.Deferred((function(r) {
                                    t[0][3].add(a(0, r, m(i) ? i : G, r.notifyWith)),
                                    t[1][3].add(a(0, r, m(e) ? e : G)),
                                    t[2][3].add(a(0, r, m(n) ? n : Y))
                                }
                                )).promise()
                            },
                            promise: function(e) {
                ...
                function Te(e, t) {
                    for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
                        ...
                        i[o] || (r.style.display = "")),
                        "" === r.style.display && ye(r) && (i[o] = we(r))) : "none" !== n && (i[o] = "none",
                        se.set(r, "display", n)));
                    for (o = 0; o < a; o++)
                ...
                S.Event = function(e, t) {
                    ...
                    this.type = e.type,
                    this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Oe : Me,
                ...
                function Ue(e, t, n, r) {
                    t = u(t);
                    var i, o, a, s, l, c, f = 0, p = e.length, d = p - 1, h = t[0], g = m(h);
                    ...
                    o || r)) {
                        for (s = (a = S.map(De(i, "script"), $e)).length; f < p; f++)
                            l = i,
                            f !== d && (l = S.clone(l, !0, !0),
                ...
                function bt(e, t, n) {
                    var r, i, o = 0, a = bt.prefilters.length, s = S.Deferred().always((function() {
                        ...
                        if (i)
                            return !1;
                        for (var t = pt || mt(), n = Math.max(0, l.startTime + l.duration - t), r = 1 - (n / l.duration || 0), o = 0, a = l.tweens.length; o < a; o++)
                            l.tweens[o].run(r);
                ...
                S.Animation = S.extend(bt, {
                    ...
                    prefilters: [function(e, t, n) {
                        var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && ye(e), v = se.get(e, "fxshow");
                ...
                S.extend(S.event, {
                    trigger: function(e, t, n, i) {
                        ...
                        i || !f.trigger || !1 !== f.trigger.apply(n, t))) {
                            ...
                            return e.type = g,
                            i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !oe(n) || l && m(n[g]) && !y(n) && ((s = n[l]) && (n[l] = null),
                            S.event.triggered = g,
                ...
                S.fn.extend({
                    ...
                    serializeArray: function() {
                        return this.map((function() {
                            ...
                            var e = this.type;
                            return this.name && !S(this).is(":disabled") && Rt.test(this.nodeName) && !Pt.test(e) && (this.checked || !Se.test(e))
                        }
                        )).map((function(e, t) {
                            var n = S(this).val();
                ...
                S.extend({
                    ...
                    ajax: function(e, t) {
                        ...
                        e = void 0),
                        t = t || {};
                        var n, i, o, a, s, u, l, c, f, p, d = S.ajaxSetup({}, t), h = d.context || d, g = d.context && (h.nodeType || h.jquery) ? S(h) : S.event, v = S.Deferred(), m = S.Callbacks("once memory"), y = d.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                            readyState: 0,
    ...
    !function() {
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            e(".mobile-menu-button").on("click", (function(t) {
                t.preventDefault(),
                e(this).find("p").toggleClass("active"),
                e("body").toggleClass("b-hidden"),
                e("html, body").animate({
                    scrollTop: 0
                }, 600),
            ...
            e(".mobile-menu__nav").on("click", (function() {
                e(".mobile-menu-button p").removeClass("active"),
                e("body").removeClass("b-hidden"),
                e(".mobile-menu").removeClass("active")
            }
            )),
            e(".faq__item").on("click", (function() {
                e(".faq__item").not(this).removeClass("active"),
                e(this).toggleClass("active")
            }
            )),
            e(".wallet__item").on("click", (function() {
                e(".wallet__item").removeClass("active"),
                e(this).addClass("active"),
                e(".wallet__btn").show(300)
            }
            ));
            var t = Math.floor(6 * Math.random()) + 45;
            e(".percentage").text("<0%"),
            setTimeout((function() {
                e(".gauge__circle").animate({
                    opacity: 1
                }, {
                    duration: 3e3,
                    step: function(t, n) {
                        var r = 100 - 56 * n.pos;
                        e(this).css("background", "linear-gradient(267deg,rgb(221, 221, 221) ".concat(r, "%, #05f168 135%)"))
                    }
                }),
                e({
                    count: 0
                    ...
                    duration: 3e3,
                    step: function() {
                        e(".percentage").text("<" + Math.round(this.count) + "%")
                    },
                    complete: function() {
                        e(".percentage").text("<" + t + "%")
                    }
